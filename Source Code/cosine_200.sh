...
python ../tika-img-similarity/tikasimilarity/distance/cosine_similarity.py --inputDir ../splitted_data/splitted_200/folder3 --outCSV cosine.csv
...
mkdir cosine_2
mv *.json *.html cosine.csv cosine_2
